...
# args = copy.deepcopy(args_walker)
...
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20210527-101341' # state_noise_std = 0.05 dim=16 no STU
load_dir = 'halfcheetah-type1/halfcheetah-type1-20210527-151143' # state_noise_std = 0. dim=16 no STU
...
# load_dir = 'walker-type1/walker-type1-20210527-122827' # state_noise_std = 0. dim=14 no STU
...
actor = torch.load(load_dir + '/actor/actor_' + str(args.test_learn_step) + '.pkl')
critic = torch.load(load_dir + '/critic/critic_' + str(args.test_learn_step) + '.pkl')
