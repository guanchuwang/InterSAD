...
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201102-202101' # train_noise_std = 0.05 dim=16
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201102-214433' # train_noise_std = 0.05 dim=24
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201103-082949' # train_noise_std = 0.05 dim=8

# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201103-111722' # train_noise_std = 0.05 dim=16 复现
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201103-115530' # train_noise_std = 0.05 dim=16 复现
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201103-124532' # train_noise_std = 0.05 dim=16 复现
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20201212-164030'

# load_dir = 'halfcheetah-type1/halfcheetah-type1-20210521-115315' # train_noise_std = 0.05 dim=16 no ERM
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20210527-101341' # train_noise_std = 0.05 dim=16 no STU bad
# load_dir = 'halfcheetah-type1/halfcheetah-type1-20210527-151143' # train_noise_std = 0.0 dim=16 no STU bad

# walker
# load_dir = 'walker-type1/walker-type1-20201020-224319' # train_noise_std = 0. dim=14
# load_dir = 'walker-type1/walker-type1-20201021-013018' # train_noise_std = 0. dim=7
# load_dir = 'walker-type1/walker-type1-20201021-150642' # train_noise_std = 0.05 dim=14
load_dir = 'walker-type1/walker-type1-20210527-122827' # train_noise_std = 0. dim=14 no STU good
# load_dir = 'walker-type1/walker-type1-20210527-171229' # train_noise_std = 0. dim=14 no STU no ERM

# ant
# load_dir = 'ant-type1/ant-type1-20201021-154917' # state_noise_std = 0.05 dim=18
# load_dir = 'ant-type1/ant-type1-20210527-134650' # state_noise_std = 0. dim=18 no STU good
...
learn_step_buf = list(range(0, 5000, 100))
...
for idx, learn_step in enumerate(learn_step_buf):
    ...
    state_time_series = torch.zeros((mdps.mdp_num, args.trajectory_len, state_dim))
    ...
    for mdp_index in range(args.mdp_num):
        ...
        for step in range(args.trajectory_len):
            ...
            state_noise = np.random.normal(0, args.state_noise_std, (state_dim,)) # args.state_noise_std
    ...
    # feature = state_time_series.reshape(mdps.mdp_num, -1).detach().numpy()
    # feature = state_action_time_series.reshape(mdps.mdp_num, -1).detach().numpy()
