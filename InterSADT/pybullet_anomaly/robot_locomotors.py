...
from pybullet_anomaly.noisy_robot_bases import MJCFBasedRobot_noisy
from pybullet_anomaly.robot_bases import BodyPart, MJCFBasedRobot
...
class WalkerBase(MJCFBasedRobot):
  ...
  def robot_specific_reset(self, bullet_client):
    ...
    for j in self.ordered_joints:
      ...
      # j.reset_current_position(self.np_random.uniform(low=-0.4, high=0.4), 0) # bad
      # j.reset_current_position(self.np_random.uniform(low=-0.25, high=0.25), 0) # bad
  ...
  def calc_state(self):
    ...
    more = np.array(
        ...
        dtype=np.float32)
    # print(more.shape, j.shape, self.feet_contact.shape)
...
class WalkerBase_noisy(MJCFBasedRobot_noisy):

  def __init__(self, fn, robot_name, action_dim, obs_dim, power, noise_std=0):
    MJCFBasedRobot_noisy.__init__(self, fn, robot_name, action_dim, obs_dim, noise_std=noise_std)
    self.power = power
    self.camera_x = 0
    self.start_pos_x, self.start_pos_y, self.start_pos_z = 0, 0, 0
    self.walk_target_x = 1e3  # kilometer away
...
class HopperBrother(WalkerBase):
  foot_list = ["foot"]

  def __init__(self):
    WalkerBase.__init__(self, "hopper_brother.xml", "torso", action_dim=3, obs_dim=15, power=0.75)

  def alive_bonus(self, z, pitch):
    return +1 if z > 0.8 and abs(pitch) < 1.0 else -1

class Hopper_Type1_Anomaly_0_005(WalkerBase):
  foot_list = ["foot"]

  def __init__(self):
    WalkerBase.__init__(self, "hopper_type1_0.005.xml", "torso", action_dim=3, obs_dim=15, power=0.75)
...
class Walker2DBrother(WalkerBase):
  foot_list = ["foot", "foot_left"]

  def __init__(self):
    WalkerBase.__init__(self, "walker2d_brother.xml", "torso", action_dim=6, obs_dim=22, power=0.40)
...
class Walker2D_Type1_Anomaly_0_005(WalkerBase):
  foot_list = ["foot", "foot_left"]

  def __init__(self):
    WalkerBase.__init__(self, "walker2d_type1_0.005.xml", "torso", action_dim=6, obs_dim=22, power=0.40)
...
class Ant_Type1_Anomaly_0_008(WalkerBase):
  foot_list = ['front_left_foot', 'front_right_foot', 'left_back_foot', 'right_back_foot']

  def __init__(self):
    WalkerBase.__init__(self, "ant_type1_0.008.xml", "torso", action_dim=8, obs_dim=28, power=2.5)
...
class HalfCheetahBrother(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_025(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.025.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_03(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.03.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_035(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.035.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_04(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.04.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_05(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.05.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_055(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.055.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_06(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.06.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_063(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.063.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_065(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.065.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_07(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.07.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_075(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.075.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
...
class HalfCheetahBrother_0_08(WalkerBase):
  foot_list = ["ffoot", "fshin", "fthigh", "bfoot", "bshin",
               "bthigh"]  # track these contacts with ground

  def __init__(self):
    WalkerBase.__init__(self, "half_cheetah_brother_0.08.xml", "torso", action_dim=6, obs_dim=26, power=0.90)
