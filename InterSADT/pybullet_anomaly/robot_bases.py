...
class XmlBasedRobot:
  ...
  def addToScene(self, bullet_client, bodies):
    ...
    for i in range(len(bodies)):
      ...
      # dump=1
      # print(pybullet.POSITION_CONTROL)
  ...
  def reset(self, bullet_client):
    ...
    if (self.doneLoading == 0):
      ...
      if self.self_collision:
        self.objects = self._p.loadMJCF(os.path.join('pybullet_anomaly', self.model_xml), # os.path.join(pybullet_data.getDataPath(), "mjcf", self.model_xml),
