...
class Task:
    ...
    def set_parameter(self, **kwargs):
        self.env.envs[0].set_parameter(**kwargs)


if __name__ == '__main__':
    # task = Task('Hopper-v2', 5, single_process=False)
    # task = Task('HalfCheetahBulletEnv-v0', 5, single_process=True, seed=7)
    task = Task('MountainCarContinuous-v0', 5, single_process=True, seed=7)
    state = task.reset()
    while True:
