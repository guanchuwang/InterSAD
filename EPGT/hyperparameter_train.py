...
args_common.critic_lr = 1e-4 # 1e-3
...
args_walker_type1.state_noise_std = 0.05 # 0.
...
args_ant_type1.learn_step = 6000 # 10000
...
args_half_cheetah_type2.outlier_rate = 0. # 5

args_half_cheetah_type2.encoder_hidden_dim = 32
args_half_cheetah_type2.trajectory_len = 5
args_half_cheetah_type2.learn_step = 6000
args_half_cheetah_type2.reward_noise_std = 0. # 0.05
args_half_cheetah_type2.state_noise_std = 0.05
args_half_cheetah_type2.type = 2

args_half_cheetah_type2.save_dir = os.path.join(args_half_cheetah_type2.exp + '-type' + str(args_half_cheetah_type2.type),
                                                args_half_cheetah_type2.exp + '-type' + str(args_half_cheetah_type2.type)
                                                + '-{}'.format(time.strftime("%Y%m%d-%H%M%S")))
#-----------------------------------------------#
# args = None
